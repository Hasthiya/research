            ...
            for (i = 0; i < Cordinates.length; i++) {
                ...
                if(CordinatesWithName[i][4] == "Kitchen"){
                    ...
                    if(CordinatesWithName[i][5]){
                        ...
                        b.rect(x2 - 5, ((y2-y1) / 2 + y1) - 20 , 10, 40);
                    } else if(CordinatesWithName[i][6]){
                        b.rect(((x2-x1) / 2 + x1) - 20, y1 - 5 , 40, 10);
                ...
                if(CordinatesWithName[i][4] != "Bathroom") {
                    ...
                    if (CordinatesWithName[i][6]) {
                        if ((x2 - x1) > 150) {
                            b.rect((x2 - x1)  / 4 + x1 - topBottomWindowWidth, y1 - topBottomWindowWidth / 2, topBottomWindowHeight, topBottomWindowWidth);
                            b.rect((x2 - x1) * (3 / 4) + x1 - topBottomWindowWidth, y1 - topBottomWindowWidth / 2, topBottomWindowHeight, topBottomWindowWidth);
                        } else {
                            b.rect((x2 - x1) / 2 + x1 - topBottomWindowWidth, y1 - topBottomWindowWidth / 2, topBottomWindowHeight, topBottomWindowWidth);
                        }
                    }
                    if (CordinatesWithName[i][7]) {
                        if ((y2 - y1) > 150) {
                            b.rect((x2) - sideWindowHeight, ((y2 - y1) / 4 + y1) - sideWindowWidth / 2, sideWindowHeight, sideWindowWidth);
                            b.rect((x2) - sideWindowHeight, ((y2 - y1) * (3 / 4) + y1) - sideWindowWidth / 2, sideWindowHeight, sideWindowWidth);
                        } else {
                    ...
                    if (CordinatesWithName[i][8]) {
                        if ((x2 - x1) > 150) {
                            b.rect((x2 - x1) / 4 + x1 - topBottomWindowWidth, y2 - topBottomWindowWidth / 2, topBottomWindowHeight, topBottomWindowWidth);
                            b.rect((x2 - x1) * (3 / 4) + x1 - topBottomWindowWidth, y2 - topBottomWindowWidth / 2, topBottomWindowHeight, topBottomWindowWidth);
                        } else {
                            b.rect((x2 - x1) / 2 + x1 - topBottomWindowWidth, y2 - topBottomWindowWidth / 2, topBottomWindowHeight, topBottomWindowWidth);
                        }
                    }
                } else {
                    if (CordinatesWithName[i][5]) {
                            b.rect(x1, ((y2 - y1) / 2 + y1) - sideWindowWidth , sideWindowHeight, sideWindowWidth);
                    }
                    if (CordinatesWithName[i][6]) {
                            b.rect((x2 - x1) / 2 + x1 - topBottomWindowWidth, y1 - topBottomWindowWidth / 2, topBottomWindowHeight, topBottomWindowWidth);
                    }
                    if (CordinatesWithName[i][7]) {
                            b.rect((x2) - sideWindowHeight, ((y2 - y1) / 2 + y1) - sideWindowHeight, sideWindowHeight, sideWindowWidth);
                    }
                    if (CordinatesWithName[i][8]) {
                            b.rect((x2 - x1) / 2 + x1 - topBottomWindowWidth, y2 - topBottomWindowWidth / 2, topBottomWindowHeight, topBottomWindowWidth);
                ...
                if (CordinatesWithName.length != i + 1) {
                    ...
                    //Master Bedroom door generation
                    if(CordinatesWithName[i][4] == "Living Room"){

                        let X = CordinatesWithName[i][0];
                        let X1 = CordinatesWithName[i][2];
                        let X2 = CordinatesWithName[i + 2][0];
                        let X3 = CordinatesWithName[i + 2][2];
                        let Y = CordinatesWithName[i][1];
                        let Y1 = CordinatesWithName[i][3];
                        let Y2 = CordinatesWithName[i + 2][1];
                        let Y3 = CordinatesWithName[i + 2][3];
                        ...
                        if ((X1 == X2)) {
                            ...
                            if ((Y1 > Y2 + 40) && (Y3 > Y + 40)) {
                                if (Y <= Y2) {
                                    // b.rect(((Y3 - Y) / 2) + Y - 20, Y - 5, 10, 40);
                                    b.rect( X1 - 5,((Y1 - Y2) / 2) + Y2 - 20, 10, 40);
                                    console.log("incert door");
                                }
                                //b.rect(200, 200 , 40, 10);
                    ...
                    //Guest Bedroom door generation
                    if(CordinatesWithName[i][4] == "Guest Bedroom"){
